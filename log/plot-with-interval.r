...
counters <- list("ac_infected_state_ST_MILD", "ac_infected_state_ST_SEVERE", "ac_infected_state_ST_CRITICAL", "ac_state_ST_DEAD", "ac_state_ST_HEALTHY", "reproductive")
colors <- c("yellow", "orange", "red", "blue", "green", "cyan")
