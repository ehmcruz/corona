...
counters <- list("ac_state_ST_INFECTED", "ac_infected_state_ST_MILD", "ac_infected_state_ST_SEVERE", "ac_infected_state_ST_CRITICAL", "ac_state_ST_DEAD", "ac_state_ST_HEALTHY", "r", "reproductive", "g_reported", "ac_total_infected_state_ST_CRITICAL", "ac_total_infected_state_ST_SEVERE")
